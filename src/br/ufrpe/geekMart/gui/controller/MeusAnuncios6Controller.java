...
public class MeusAnuncios6Controller {
    ...
    protected void initialize() {
        Main.addOnChangesScreenListener(new Main.OnChangeScreen() {
            ...
            public void onScreenChanged(String newScreen, Object userData, ArrayList<Anuncio> userData2,
                ...
                if (newScreen.equals("meusAnuncios6Scene")) {
    ...
    @FXML
    protected void editarAnuncioAction6(ActionEvent e) {
        Main.trocarTela("alterarAnuncioScene", user1.get(5));
    ...
    protected void proximaAction(ActionEvent e) {
        ...
        if (user1.size() - 6 >= 6) {
            Main.trocarTela("meusAnuncios6Scene", user, user1, user2);
        }

        if (user1.size() - 6 < 6) {
            switch (user1.size() - 6) {
                case 1:
                    Main.trocarTela("meusAnuncios1Scene", user, user1, user2);
                    break;
                case 2:
                    Main.trocarTela("meusAnuncios2Scene", user, user1, user2);
                    break;
                case 3:
                    Main.trocarTela("meusAnuncios3Scene", user, user1, user2);
                    break;
                case 4:
                    Main.trocarTela("meusAnuncios4Scene", user, user1, user2);
                    break;
                case 5:
                    Main.trocarTela("meusAnuncios5Scene", user, user1, user2);
                    break;
                case 0:
