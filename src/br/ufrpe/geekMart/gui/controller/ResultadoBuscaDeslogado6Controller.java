...
public class ResultadoBuscaDeslogado6Controller {
    ...
    protected  void  initialize(){
        Main.addOnChangesScreenListener(new Main.OnChangeScreen(){
            ...
            public void onScreenChanged(String newScreen, Object userData,
                ...
                if(newScreen.equals("resultadoBuscaDeslogado6Scene")) {
                    user1 = userData2;
                    user2 = userData3;
    ...
    protected  void irParaAnuncioAction6(ActionEvent e){
        Main.trocarTela("anuncioDeslogadoScene",user1.get(5));
    ...
    protected  void proximaAction(ActionEvent e){
        ...
        if(user1.size() - 6 >= 6){
            Main.trocarTela("resultadoBuscaDeslogado6Scene",user1, user2);
        }

        if(user1.size() - 6 <6){
            switch (user1.size() - 6) {
                case 1:
                    Main.trocarTela("resultadoBuscaDeslogado1Scene",user1,user2);
                    break;
                case 2:
                    Main.trocarTela("resultadoBuscaDeslogado2Scene",user1,user2);
                    break;
                case 3:
                    Main.trocarTela("resultadoBuscaDeslogado3Scene",user1,user2);
                    break;
                case 4:
                    Main.trocarTela("resultadoBuscaDeslogado4Scene",user1,user2);
                    break;
                case 5:
                    Main.trocarTela("resultadoBuscaDeslogado5Scene",user1,user2);
                    break;
                case 0:
